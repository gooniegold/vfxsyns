 ...
 *
 * Google Drive: use `uc?export=view` for HTML5 video (not `download`).
 *
 * 1. MUSIC VIDEO — Jakk Move
 * 2. MUSIC VIDEO — Dream
...
export const PORTFOLIO_VIDEO_1_MUSIC =
  "https://drive.google.com/uc?export=view&id=1ED-AoylSRYJUiNCFEwgY-ySUWdZ0h9QW";

export const PORTFOLIO_VIDEO_2_MUSIC =
  "https://drive.google.com/uc?export=view&id=1WkvmqdWPNYCnyMKnh0NSSCSDencojM0f";

export const PORTFOLIO_VIDEO_3_COLOR =
  "https://drive.google.com/uc?export=view&id=1SVS8D6B7JjLjy8iRDv0AFBXzmiMIdcTd";

export const PORTFOLIO_VIDEO_4_COLOR =
  "https://drive.google.com/uc?export=view&id=1YogMCOTpqcgFVz8Aud8q1uuRDMi7-M9F";
