...
export function LinksTab() {
  return (
    ...
    >
      <p
        className="mb-3 text-[8px] uppercase tracking-[0.3em]"
      ...
      <div className="space-y-2">
        {BIO_LINKS.map((link, i) => (
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="group relative flex items-center gap-3 overflow-hidden rounded-xl px-3 py-3"
            style={{
              background: `linear-gradient(135deg, ${link.accentFrom}80 0%, rgba(8,8,12,0.55) 100%)`,
              border: `1px solid rgba(${link.accentRgb}, 0.18)`,
              boxShadow: `inset 0 0 20px rgba(${link.accentRgb}, 0.03)`,
              transition: "border-color 0.2s ease, box-shadow 0.2s ease",
            }}
            onMouseEnter={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.borderColor = `rgba(${link.accentRgb}, 0.4)`;
              el.style.boxShadow = `0 4px 20px rgba(${link.accentRgb}, 0.1), inset 0 0 30px rgba(${link.accentRgb}, 0.05)`;
            }}
            onMouseLeave={(e) => {
              const el = e.currentTarget as HTMLElement;
              el.style.borderColor = `rgba(${link.accentRgb}, 0.18)`;
              el.style.boxShadow = `inset 0 0 20px rgba(${link.accentRgb}, 0.03)`;
            }}
          >
            {/* Left gradient bar */}
            <div
              ...
              style={{
                background: `linear-gradient(180deg, transparent, rgba(${link.accentRgb}, 0.7), transparent)`,
              }}
            />
            ...
            <div
              ...
              style={{
                background: `linear-gradient(135deg, rgba(${link.accentRgb}, 0.16), rgba(${link.accentRgb}, 0.05))`,
                border: `1px solid rgba(${link.accentRgb}, 0.22)`,
                color: `rgba(${link.accentRgb}, 0.9)`,
                boxShadow: `0 0 10px rgba(${link.accentRgb}, 0.08)`,
              }}
            >
              {link.icon}
            </div>
            ...
            <svg
              ...
              style={{ color: `rgba(${link.accentRgb}, 0.65)` }}
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              strokeWidth={2}
