        ...
        {tabs.map((tab, index) => (
          ...
          >
            {activeTab === tab.id && (
              <motion.span
                layoutId="bubble"
                className="absolute bottom-0 w-full left-0 z-10 bg-[var(--accent)] rounded-full h-1 shadow-[0_0_10px_var(--accent)]"
            ...
            >
              {tab.id !== 0 && (
                <NewBadge className="absolute -top-2 -right-8 z-50 bg-[var(--accent)] text-white" />
              )}
